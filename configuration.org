...
** Popup agenda                                                         :org:
   #+BEGIN_SRC emacs-lisp
     ...
     (defun nist/pop-to-org-agenda-review (&optional nosplit)
       "Pop to the default agenda in a split window unless NOSPLIT."
       (interactive "P")
       (nist/pop-to-org-agenda-view "r" (not nosplit)))

     (defun nist/pop-to-org-agenda-home (&optional nosplit)
       "Pop to the default agenda in a split window unless NOSPLIT."
       (interactive "P")
       (nist/pop-to-org-agenda-view "h" (not nosplit)))
   #+END_SRC
...
** Keybindings
   #+BEGIN_SRC emacs-lisp
     ...
     (global-set-key (kbd "C-c t r") 'nist/pop-to-org-agenda-review)
     (global-set-key (kbd "C-c t h") 'nist/pop-to-org-agenda-home)
